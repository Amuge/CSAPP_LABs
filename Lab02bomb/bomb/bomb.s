...
0000000000400f43 <phase_3>:
  ...
  400f60:	83 f8 01             	cmp    $0x1,%eax # b,%eax should > 0x1,it store the number of input args?(guess)
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) # unsigned M[%rsp + 8] should <= 0x7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax # %eax = M[%rsp + 8], index??? case???
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8) # b,when $rax==1,jmp to 0x400fb9
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax # jmp addr
  400fc2:	74 05                	je     400fc9 <phase_3+0x86> # %eax == M[%rsp + c] == 0x137
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax # 0x40103a -> %edx == 0xe -> %eax == 0xe
  400fd4:	29 f0                	sub    %esi,%eax # 0x40103f -> %esi == 0x0 -> %eax == 0xe
  400fd6:	89 c1                	mov    %eax,%ecx # %ecx == 0xe
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx # logical right shift , %ecx >>= 31 -> 0x0
  400fdb:	01 c8                	add    %ecx,%eax # %eax == 0xe
  400fdd:	d1 f8                	sar    %eax # arithmetic right shift， %eax >>= 1 -> (0xe -> 0x7)
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # %ecx = 0x7
  400fe2:	39 f9                	cmp    %edi,%ecx # 0x401044 -> %edi == 1st arg
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # jmp if %ecx <= 1st arg -> jmp if 1st arg >= 0x7
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax # if 1st arg >= 0x7 -> %eax == 0
  400ff7:	39 f9                	cmp    %edi,%ecx 
  400ff9:	7d 0c                	jge    401007 <func4+0x39> # jmp if %ecx >= 1st arg -> if 1st arg <= 0x7,exit func wit %eax == 0
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx # 2nd arg addr in stack
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx # 1st arg addr in stack
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi # x/s 0x4025cf -> "%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax # %eax == 0x2 -> 2 args(guess)
  40102c:	75 07                	jne    401035 <phase_4+0x29> # if %eax != 2 -> fail
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) 
  401033:	76 05                	jbe    40103a <phase_4+0x2e> # jmp if 1st arg is below/equal 0xe,to avoid explode_bomb
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi # %edi == 1st arg
  401048:	e8 81 ff ff ff       	call   400fce <func4>
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c> # jmp if %eax is not zero -> %eax should be zero
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) # if 2nd arg == 0x0, success defuse
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx # input "9fe567" -> %rbx == %rdi == 0x6038c0
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax # %fs:0x28 Segment:Offset -> addr
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp) # %rax == 0xbc770700
  401078:	31 c0                	xor    %eax,%eax # %eax -> 0x0
  40107a:	e8 9c 02 00 00       	call   40131b <string_length> # arg %rdi
  40107f:	83 f8 06             	cmp    $0x6,%eax # input length should be 0x6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	call   40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>
  # --------------------------------LOOP---------------------------------
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx # loop entry,%ecx = M[%rbx+%rax],%rax == 0 at first
  40108f:	88 0c 24             	mov    %cl,(%rsp) # %cl -> lowest 4 bytes in %rcx , put each char of input into M[%rsp]
  401092:	48 8b 14 24          	mov    (%rsp),%rdx # %rdx == input char
  401096:	83 e2 0f             	and    $0xf,%edx # save lowest 4 bytes in %edx
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx # %edx = M[0x4024b0 + %rdx],0x4024b0->sth about secret stage
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1) # %dl -> lowest 4 bytes in %rdx
  4010a4:	48 83 c0 01          	add    $0x1,%rax 
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax # %rax -> i, test if ++i != 6 ? jne(loop) : movb
  ...
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax # 1st jmp point after get input
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax # compare M[%rsp + 0x18] with M[%fs + 0x28]
  4010e5:	00 00 
  4010e7:	74 05                	je     4010ee <phase_5+0x8c> # if equal, success defuse
...
00000000004010f4 <phase_6>:
  ...
  40110b:	49 89 e6             	mov    %rsp,%r14 # input at %rsp + i*4(for i in range[0,5])
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d # %r12d = 0x0 -> 1st input, %r12d = 5 -> 6th input
  # -------------------------------loop_entry----------------------------------------------
  401114:	4c 89 ed             	mov    %r13,%rbp # %rbp = %rsp at first, %r13 += 0x4 for each loop
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax # %eax = 1st,2nd....6th input
  40111b:	83 e8 01             	sub    $0x1,%eax # %eax -= 1
  40111e:	83 f8 05             	cmp    $0x5,%eax # %eax <= 0x5 ? -> 1st,2nd...6th input <= 6
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d # %r12d ++
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d # %r12d == 0x6 ?
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx # %ebx = 1,2,3,4,5
  # -----------------------------diff_loop_start---------------------------------------------
  401135:	48 63 c3             	movslq %ebx,%rax # %rax = 1,2,3,4,5
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax # %eax = 2nd ~ 6th? val
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp) # cmp 1st input with rest input,should be diff
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx # %ebx++
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41> # make sure other input val is diff from 1st input
  # -----------------------------diff_loop_end----------------------------------------------
  40114d:	49 83 c5 04          	add    $0x4,%r13 # %r13 = %rsp + 0x4 at first
  401151:	eb c1                	jmp    401114 <phase_6+0x20> # ###make sure each input is unique and <= 6
  # -----------------------------loop_end----------------------------------------------------------
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi # if %r12d == 6, put the upper bound addr into %rsi
  401158:	4c 89 f0             	mov    %r14,%rax # %rax = %rsp
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx # %ecx = 0x7, initialize
  # ----------------------------LOOP_Start-----------------------------------------
  401160:	89 ca                	mov    %ecx,%edx # %edx = 0x7
  401162:	2b 10                	sub    (%rax),%edx # %edx = 0x7 - 1st input
  401164:	89 10                	mov    %edx,(%rax) # M[%rsp] = 0x7 - 1st input
  401166:	48 83 c0 04          	add    $0x4,%rax # %rax = %rsp + 0x4
  40116a:	48 39 f0             	cmp    %rsi,%rax # check bound
  40116d:	75 f1                	jne    401160 <phase_6+0x6c> # make each input 'x' -> '7-x' -> input become >= 1 since each input should <= 6
  # ----------------------------LOOP_End-----------------------------------------
  40116f:	be 00 00 00 00       	mov    $0x0,%esi # Initialize of LOOP_2
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  # ----------------------------Inner_LOOP_2_When Find 1 < %ecx <=6 ----------------------------------------------
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx # %rdx = 0x6032d8 at first,pointer to next node
  40117a:	83 c0 01             	add    $0x1,%eax # %rdx will equal to 0x6032d0 + (%ecx - 1) * 0x8
  40117d:	39 c8                	cmp    %ecx,%eax # when jump to this loop,it indicates %ecx > 1
  40117f:	75 f5                	jne    401176 <phase_6+0x82> # to make %eax have same val as %ecx, %rdx store the corresponding addr of linked list
  # ----------------------------Inner_LOOP_2_End----------------------------------------------
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  # ----------------------------LOOP_2_Start When Find %ecx is == 1---------------------------------------
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx # x/24wd 0x6032d0 -> linked list,332->168->924->691->477->443
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) # put %rdx into M[%rsp+0x20+2*%rsi]
  40118d:	48 83 c6 04          	add    $0x4,%rsi
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx # %ecx = M[%rsp + %rsi],%rsi = 0 at first
  40119a:	83 f9 01             	cmp    $0x1,%ecx
  40119d:	7e e4                	jle    401183 <phase_6+0x8f> # if %ecx == 0x1, jmp to the Loop_2 start
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82> # if %ecx > 0x1, jmp to the Inner Loop_2
  # ----------------------------LOOP_2_End---------------------------------------
  # ----------------------------JMP_Here_When_All_Linked_Node_Addr_Have_Stored in Stack-----------------------
  # - %rsp + 0x20 == 0x6032d0 -> 332 ,2d8 -> 2e0 
  # - %rsp + 0x28 == 0x6032e0 -> 168 ,2e8 -> 0
  # - %rsp + 0x30 == 0x6032f0 -> 924 ,2f8 -> 300
  # - %rsp + 0x38 == 0x603300 -> 691 ,338 -> 310
  # - %rsp + 0x40 == 0x603310 -> 477 ,318 -> 320
  # - %rsp + 0x48 == 0x603320 -> 443 ,328 -> 2d0
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx # %rbx == 0x6032f0 at first
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax # %rax == %rsp + 0x28 at first
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi # %rsi = %rsp + 0x50
  4011ba:	48 89 d9             	mov    %rbx,%rcx # %rcx = 0x6032f0
    # ---------------------------inner_loop-------------------------------------------
  4011bd:	48 8b 10             	mov    (%rax),%rdx # %rdx should become 0x60330
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx) # M[0x6032f8] = 0x603330 
  4011c4:	48 83 c0 08          	add    $0x8,%rax # %rax == %rsp + 0x30
  4011c8:	48 39 f0             	cmp    %rsi,%rax # %rsi == %rsp + 0x50,upper bound
  4011cb:	74 05                	je     4011d2 <phase_6+0xde> # reach bound,go to final loop
  4011cd:	48 89 d1             	mov    %rdx,%rcx # %rcx become 0x603330
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
    # ---------------------------inner_loop-------------------------------------------
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx) # %rdx should be 0x6032e0
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  # -----------------------------LOOP_Final--------------------------------
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax # %rbx==0x6032f0,%rax=0x603300,%rbx->cur_node,%rax->next_node
  4011e3:	8b 00                	mov    (%rax),%eax # %eax = val of next node
  4011e5:	39 03                	cmp    %eax,(%rbx) # if Val[cur_node] >= Val[next_node],skip the bomb
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	call   40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx # %rbx now point to the next node
  4011f2:	83 ed 01             	sub    $0x1,%ebp # when %ebp become 0 -> success defuse
...
000000000040131b <string_length>:
  ...
  401323:	48 83 c2 01          	add    $0x1,%rdx # point to next char
  401327:	89 d0                	mov    %edx,%eax
  401329:	29 f8                	sub    %edi,%eax # compute distance (string length)
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx) # check if the next char is '\0'
...
0000000000401338 <strings_not_equal>:
  ...
  401342:	e8 d4 ff ff ff       	call   40131b <string_length> # get 1st arg length(%rdi)
  401347:	41 89 c4             	mov    %eax,%r12d # result stored in %r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi # %rsi -> %rbp -> %rdi
  40134d:	e8 c9 ff ff ff       	call   40131b <string_length> # get 2nd arg length(%rsi),stored in %rax
  401352:	ba 01 00 00 00       	mov    $0x1,%edx
  401357:	41 39 c4             	cmp    %eax,%r12d # 2nd arg len, 1st arg len
  ...
  40139b:	89 d0                	mov    %edx,%eax # not equal, %eax == 0x1
  40139d:	5b                   	pop    %rbx
  40139e:	5d                   	pop    %rbp
...
000000000040145c <read_six_numbers>:
  ...
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx # %rcx = M[%rsi + 0x4]
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp) # M[%rsp + 0x8] = M[%rsi + 0x14]
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax # %rax = M[%rsi + 0x10]
  401474:	48 89 04 24          	mov    %rax,(%rsp) # M[%rsp] = M[%rsi + 0x10]
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9 # %r9 = M[%rsi + 0xc]
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8 # %r8 = M[%rsi + 0x8]
